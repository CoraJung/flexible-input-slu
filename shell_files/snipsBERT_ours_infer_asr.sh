...
#SBATCH --job-name=snipsBERT_ours_infer_asr
#SBATCH --mail-type=END
#SBATCH --mail-user=sjc433@nyu.edu
#SBATCH --output=snipsBERT_ours_infer_asr_all_%j.out
#SBATCH --gres=gpu:1
...
DATASET=snips
DATA_PATH=//misc/vlgscratch5/PichenyGroup/s2i-common/alexa-slu/snips_slu/data/asr_test
